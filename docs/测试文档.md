...
```
┌─────────────────────────────────────────────────────────────┐
│                    Job1: Conditional Flow                   │
├─────────────────────────────────────────────────────────────┤
│                                                              │
│  conditionalImportStep (导入数据)                             │
│      ↓                                                       │
│  resultDecider (决策器)                                       │
│      ↓           ↓           ↓                               │
│  [COMPLETED]  [COMPLETED_WITH_SKIPS]  [FAILED]               │
│      ↓           ↓                    ↓                       │
│  successStep  successStep         failureStep                │
│  (成功提示)   (带skip提示)       (失败提示)                   │
│                                                              │
└─────────────────────────────────────────────────────────────┘
```
...
├─────────────────────────────────────────────────────────────┤
│                                                              │
│  step1Import (导入数据到 DB2)                                │
│      ↓                                                       │
│  step2SyncToDb3 (DB2 → DB3)                                 │
│      ↓                                                       │
│  step3SyncToDb4 (DB2 → DB4)                                 │
│      ↓                                                       │
│  decisionStep4 (决策器)                                       │
│      ↓                   ↓               ↓                    │
│  [FAILED]       [COMPLETED_WITH_SKIPS]  [COMPLETED]          │
│      ↓                   ↓               ↓                    │
│  step5FailureMail    step6SuccessMail  step6SuccessMail      │
│  (发送失败邮件)       (发送警告邮件)     (发送成功邮件)        │
│                          ↓               ↓                    │
│                     step7Export      step7Export             │
│                     (导出数据)        (导出数据)              │
│                                                              │
└─────────────────────────────────────────────────────────────┘
```
