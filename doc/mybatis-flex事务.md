...
注意事项
1.使用seata-spring-boot-starter的时候请关闭自动代理
...
示例
mybatis-flex-spring-boot-seata-demo : Seata 官方 demo 与 flex 结合。
...
使用可以跨越线程池的ThreadLocal比如阿里的transmittable-thread-local 导入如下的包
xml
     <dependency>
